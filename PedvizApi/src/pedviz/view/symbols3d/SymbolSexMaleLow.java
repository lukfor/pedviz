 ...
 * 
 */
public class SymbolSexMaleLow extends Symbol3D {

    public SymbolSexMaleLow() {
	super(0);
    }
	...
	quadArray.setCoordinate(0, new Point3f(p.x - size / 2, p.y - size / 2,
		p.z));

	quadArray.setColor(1, new Color4f(c));
	quadArray.setCoordinate(1, new Point3f(p.x - size / 2, p.y + size / 2,
		p.z));

	quadArray.setColor(2, new Color4f(c));
	quadArray.setCoordinate(2, new Point3f(p.x + size / 2, p.y + size / 2,
		p.z));
	quadArray.setColor(3, new Color4f(c));
	quadArray.setCoordinate(3, new Point3f(p.x + size / 2, p.y - size / 2,
		p.z));

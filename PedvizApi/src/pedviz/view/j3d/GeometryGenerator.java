 ...
 * implementation decide. Our aim is for speed here and if we have to decide in
 * a general fashion for every normal calculation, that could be a huge impact.
 * <P>
...
public abstract class GeometryGenerator {
    ...
    /**
     * Convenience method to create a normal for the given vertex coordinates
     * and normal array and using a 2D array of coordinate values. This performs
     * a cross product of the two vectors described by the middle and two end
     * points.
     * 
     * @param coords
     *                The coordinate array to read values from
     * @param w
     *                The reference into the first array dimension for p
     * @param p
     *                The index of the middle point
     * @param w1
     *                The reference into the first array dimension for p1
     * @param p1
     *                The index of the first point
     * @param w2
     *                The reference into the first array dimension for p2
     * @param p2
     *                The index of the second point
     * @return A temporary value containing the normal value
     */
    protected Vector3f createFaceNormal(float[][] coords, int w, int p, int w1,
	    int p1, int w2, int p2) {
     ...
     * point in space, relative to the origin. This will create a normal that
    ...
    /**
     * Create a normal based on the given vertex position, assuming that it is a
     * point in space, relative to the given point. This will create a normal

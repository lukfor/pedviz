 ...
 * 
 */
public class ShapeRule2 extends Rule {
     ...
     *                symbol
     */
    public ShapeRule2(String userData, Object value, Object value1, Symbol shape) {
     ...
     *                symbol
     */
    public ShapeRule2(Symbol shape) {
	this.userData = null;
	this.value = null;
	this.shape = shape;
    }
	...
	if (!nodeview.getNode().isDummy()) {
		...
		if (currentValue != null) {
		    if (!currentValue.equals(value) && !currentValue.equals(value1))

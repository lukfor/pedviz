...
import pedviz.haplotype.MerlinErrorChecking;
...
public class Example31 {
	...
	PedGraphLoader loader = new PedGraphLoader("data/pedigree.ped");
	...
	haplotypes = new MerlinHaplotypes("data/merlin.chr",
		"data/pedigree.map");
